...
export class ComponentService {
  ...
  public readonly globalCodeApiEndpoints = ApiEndpoints.GlobalCodeCategory;
  ...
  // GlobalCode/getglobalcodes
  getGlobalCodeData(value: string): Observable<any> {
    const params = new HttpParams()
      .set('CategoryName', `${value}`)
    return this.httpService.get(this.globalCodeApiEndpoints.GlobalCodeName, { params });
  }
}
